# -*- coding: utf-8 -*-
"""image-captioner_custom_train_CNN-LSTM-v2.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1q0xJcNa5_eQIGp_F3_Mtg4a6VNG4t0Cg
...
pickle.dump(image_to_captions_mapping, open(os.path.join(OUTPUT_DIR, 'image_to_captions_mapping.pkl'), 'wb'))
...
with open('/content/working/img_features.pkl', 'rb') as features_file:
...
model_ = load_model('/content/working/mymodel.h5')
...
!cp -r /content/tokenizer.pkl /content/working

!zip -r /content/working.zip /content/working
